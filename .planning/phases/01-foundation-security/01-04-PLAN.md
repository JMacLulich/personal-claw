...
2. `check_inbox()` async method:
   ...
   - Example return: "📬 You have 5 messages in your inbox"
...
4. Add `/status` command:
   ...
   - Example: "✅ Personal-Claw is running. 5 messages in inbox."
...
**Expected results:**
- ✅ Bot responds to your commands only
- ✅ /check-inbox shows Gmail inbox summary
